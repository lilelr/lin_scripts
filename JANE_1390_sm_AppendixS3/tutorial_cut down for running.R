...
model.data <- read.csv("~/Documents/JANE_1390_sm_AppendixS3/data/model.data.csv")
...
source("scratch.R")
save.image("~/Documents/JANE_1390_sm_AppendixS3/data/.RData")
...
eval.data <- read.csv("~/Documents/JANE_1390_sm_AppendixS3/data/eval.data.csv", as.is=T)
...
# Import them into R:
grid.names <- c("~/Documents/JANE_1390_sm_AppendixS3/data/mask.asc", "~/Documents/JANE_1390_sm_AppendixS3/data/segsumt.asc", "~/Documents/JANE_1390_sm_AppendixS3/data/segtseas.asc","~/Documents/JANE_1390_sm_AppendixS3/data/seglowflow.asc","~/Documents/JANE_1390_sm_AppendixS3/data/dsdist.asc","~/Documents/JANE_1390_sm_AppendixS3/data/dsmaxslope.asc","~/Documents/JANE_1390_sm_AppendixS3/data/usavgt.asc","~/Documents/JANE_1390_sm_AppendixS3/data/usraindays.asc","~/Documents/JANE_1390_sm_AppendixS3/data/usslope.asc", "~/Documents/JANE_1390_sm_AppendixS3/data/usnative.asc", "~/Documents/JANE_1390_sm_AppendixS3/data/dsdam.asc", "~/Documents/JANE_1390_sm_AppendixS3/data/locsed.asc")
...
gbm.predict.grids(angaus.tc5.lr005, preddat, want.grids = T, sp.name = "angaus_preds",pred.vec = rep(-9999,49000), filepath = "~/Documents/JANE_1390_sm_AppendixS3/data/", num.col = 250, num.row = 196, xll = 0, yll = 0, cell.size = 100, no.data = -9999, plot=T) 
...
gbm.predict.grids(angaus.tc5.lr005, preddat, want.grids = T, sp.name = "angaus_preds2",pred.vec = rep(-9999,250 * rep.rows[1]), filepath = "~/Documents/JANE_1390_sm_AppendixS3/data/", num.col = 250, num.row = 196, xll = 0, yll = 0, cell.size = 100, no.data = -9999, plot=T, full.grid = F, part.number = 1, part.row = rep.rows[1]) 
...
gbm.predict.grids(angaus.tc5.lr005, preddat, want.grids = T, sp.name = "angaus_preds2",pred.vec = rep(-9999,250 * rep.rows[i]), filepath = "~/Documents/JANE_1390_sm_AppendixS3/data/", num.col = 250, full.grid = F, part.number = i, part.row = rep.rows[i], header = F) 
}
